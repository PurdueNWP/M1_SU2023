...
This file was originally created as a [Quarto](https://quarto.org/) Markdown document. The first block seen above is called the YAML, a human-readable data-serialization
...
include the method to render the document, such as the Jupyter engine specified with **Jupyter: python** in the YAML.
